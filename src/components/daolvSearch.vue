...
<div class="search-bar">
    ...
    <Form class="search-form" ref="form" :model="form" inline>
        ...
        <FormItem label="星级" :label-width="50" style="width:150px" prop="level" v-if="parent">
            <Select v-model="form.level" placeholder="星级">
                <Option
        ...
        <FormItem label="等级" :label-width="50" style="width:150px" prop="level" v-if="guide">
            <Select v-model="form.type" placeholder="等级">
                <Option
        ...
        <FormItem>
            <Button :disabled="loading" @click="onReset()">清空</Button>
...
export default {
    ...
    methods: {
        ...
        getCity() {
            ...
            this.$fly.post('/evaluation/api/common/queryCity', formData)
            .then((res) => {
                let data = res.data || {}
        ...
        setChildCityList() {
            ...
            this.$fly.post('/evaluation/api/common/queryDistrict', formData)
            .then((res) => {
                let data = res.data || {}
        ...
        setHeight() {
            let iframe = parent.document.getElementById('company')
            if (iframe) {
